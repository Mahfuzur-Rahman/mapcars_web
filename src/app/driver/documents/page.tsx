...
const TYPES: { value: DriverDocumentType; label: string }[] = [
  { value: "PhvLicence", label: "PHV licence" },
  { value: "VehicleInsurance", label: "Vehicle insurance" },
  { value: "VehicleRegistration", label: "Vehicle registration" },
  { value: "DbsCheck", label: "DBS check" },
  { value: "Passport", label: "Passport" },
  { value: "DrivingLicence", label: "Driving licence" },
  { value: "VehicleBadge", label: "Vehicle PHV badge" },
  { value: "BankStatement", label: "Bank statement" },
  { value: "ProofOfAddress", label: "Utility bill" },
];

// The API requires an expiry date for these document types.
    ...
    <div className="p-8">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-zinc-500">
          Upload your PHV licence and vehicle documents for approval.
        </p>
      </div>
