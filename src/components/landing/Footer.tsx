...
const SOCIALS = [
  {
    name: "facebook",
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61592078572248",
    external: true,
  ...
  },
  {
    name: "instagram",
    label: "Instagram",
    href: "https://www.instagram.com/map91868/",
    external: true,
    ...
    <footer className="footer" id="footer">
      <div className="footer-container">
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <p className="footer-desc">
              Reimagining urban mobility across the South Coast. Premium rides
              at your fingertips, arriving soon.
            </p>
        ...
        <div className="footer-bottom">
          <p>&copy; 2026 MapCars. All rights reserved.</p>
          <p>Made with ❤️ in Chichester</p>
        </div>
      </div>
    </footer>
  );
